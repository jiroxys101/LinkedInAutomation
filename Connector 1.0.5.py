...
def setup(datetime=datetime):
    ...
    if len(results) < 170:
        ...
        num = random.randint(170, 190)  # set to 5 for testing
        ...
        while count1 < num:
            if count2 < 5:  # test
                ...
                if not skill_fragment:
                    ...
                    sentence = "I was looking at your profile and couldn't help but notice your years of experience, and your strong "\
