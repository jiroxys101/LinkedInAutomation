...
is_int = True
while is_int:
    cycle_time = int(input("Enter how many minutes you would like a cycle to last for:"))
        ...
        while count1 < num:
            if count2 < 5:  # test
                ...
                area_list = ["new york", "new jersey", "toronto", "mississauga", "brampton", "scarborough",
                             ...
                             "ohio",
                             "washington dc", "washington, dc", "montreal", "washington d.c", "canada", "trinidad", "tobago",
                             "texas"]
                ...
                if connect_bool:
                    ...
                    try:
                        ...
                        message_script = greeting + name + "! " + "I'm always looking to network with strong professionals! Hope we can add value to each other"
