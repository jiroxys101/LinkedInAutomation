...
locations = {"Greater New York City Area": "us%3A70",
             "Greater Philadelphia Area": "us%3A77",
             "Washington D.C. Metro Area": "us%3A97",
             "Baltimore, Maryland Area": "us%3A7416",
             "Dover, Delaware Area": "us%3A219",
...
def set_up():
    ...
    num = 1
    page = str(num)
    recruiter_URL = 'https://www.linkedin.com/search/results/people/?facetGeoRegion=%5B%22' + encode + '%22%5D' + \
        ...
        if errors < 6:
            ...
            try:
                ...
                if "No Results Found" in results_found_elem:
                    ...
                    print(loopy + 1, end="")
                    try:
                        WebDriverWait(driver, 60).until(lambda driver: driver.find_elements_by_xpath(
                            "//div[contains(@class, 'search-filters-bar')]"))
                    except TimeoutException:
                        print("Script Failure 1")
