...
is_int = True
while is_int:
    cycle_time = int(input("Enter how many seconds you would like a cycle to last for:"))
...
print("Cycling for " + str(cycle_time) + " seconds")
...
def setup():
    ...
    hook4_list = ['Hope you are doing well during this time with everything that has been going on',
    ...
    filler_1 = 'I understand that there is a lot of uncertainty in the air today'

    filler_2 = ['As an organization, we are looking to assemble a team of freelancers to help us develop a larger market presence',
                'My organization is looking to assemble a team of freelancers to help us develop a larger market presence']

    filler_3 = "I was going through your profile and couldn't help but notice that you have been endorsed for a variety of skills, including "
    ...
    filler_4 = ['Without impacting your existing commitments',
    ...
    while count1 < num:
        if count1 != 0:
            if count1 % 25 == 0:  # test
                ...
                time_2 = time.time()
                wait_1 = round(time_2 - time_1, 0)
                wait_2 = cycle_time - wait_1
        ...
        area_list = ["new york", "new jersey", "toronto", "mississauga", "brampton", "scarborough",
                     ...
                     "ohio",
                     "washington dc", "washington, dc", "montreal", "washington d.c", "trinidad", "tobago", 'texas']
        ...
        while is_int:
            ...
            try:
                ...
                if numpy <= 1:
                    ...
                    try:
                        ...
                        try:
                            ...
                            try:
                                ...
                                message_script = str(random.choice(acknowledgements))
                                message_script = message_script.replace("  ", " ")
                                text_area_element.send_keys(str(message_script))
                                time.sleep(random.randint(1, 3))
                                driver.execute_script('arguments[0].click();', send_button_element)
                                ...
                                message_script = str(random.choice(hook4_list))
                                message_script = message_script.replace("  ", " ")
                                text_area_element.send_keys(str(message_script))
                                time.sleep(random.randint(1, 3))
                                driver.execute_script('arguments[0].click();', send_button_element)
                                ...
                                message_script = str(random.choice(hook3_list))
                                message_script = message_script.replace("  ", " ")
                                text_area_element.send_keys(str(message_script))
                                time.sleep(random.randint(1, 3))
                                driver.execute_script('arguments[0].click();', send_button_element)
                                ...
                                message_script = str(random.choice(filler_2))
                                message_script = message_script.replace("  ", " ")
                                text_area_element.send_keys(str(message_script))
                                time.sleep(random.randint(1, 3))
                                driver.execute_script('arguments[0].click();', send_button_element)
                                ...
                                message_script = str(filler_3) + str(random.choice(interpersonal_skills_array))
                                message_script = message_script.replace("  ", " ")
                                text_area_element.send_keys(str(message_script))
                                time.sleep(random.randint(1, 3))
                                driver.execute_script('arguments[0].click();', send_button_element)
                                ...
                                message_script = str(random.choice(hook2_list))
                                message_script = message_script.replace("  ", " ")
                                text_area_element.send_keys(str(message_script))
                                time.sleep(random.randint(1, 3))
                                driver.execute_script('arguments[0].click();', send_button_element)
                                ...
                                message_script = str(random.choice(filler_4))
                                message_script = message_script.replace("  ", " ")
                                text_area_element.send_keys(str(message_script))
                                time.sleep(random.randint(1, 3))
                                driver.execute_script('arguments[0].click();', send_button_element)
                    ...
                    try:  # see if there is an open message window
                        msg_close_element = WebDriverWait(driver, 2).until(
                            lambda driver: driver.find_element_by_xpath
                            ("//button[contains(@class, 'msg-close')]"))
                        msg_close_element.click()
